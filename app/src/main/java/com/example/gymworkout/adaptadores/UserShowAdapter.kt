...
import com.example.gymworkout.databinding.UserViewBinding
import com.example.gymworkout.entidades.User

class UserShowAdapter(private val userList: ArrayList<User>, private val context: Context) :
    RecyclerView.Adapter<UserShowAdapter.ViewHolder>() {
